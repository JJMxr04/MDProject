...
entitlement — the analytics dashboard is free. (PRO gating
moved to opponent scouting, which is where ``IsPaid`` will be used.)
...
class EventAnalyticsView(V1ViewMixin, APIView):
    """Aggregator analytics for one event. Auth required; free."""
    ...
    def get(self, request, event_id: str):
        ...
        # Analytics is free; no entitlement gate here.
