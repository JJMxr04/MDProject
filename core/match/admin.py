...
class MatchAdmin(admin.ModelAdmin):
    ...
    #     'player_1_game_1', 
    #     'player_1_game_1_completed',
    #     'player_1_game_2', 
    #     'player_1_game_2_completed',
    #     'player_1_game_3', 
    #     'player_1_game_3_completed',
    #     'player_1_game_4', 
    #     'player_1_game_4_completed',
    #     'player_1_game_5', 
    #     'player_1_game_5_completed',
    #     'player_2_game_1', 
    #     'player_2_game_1_completed',
    #     'player_2_game_2', 
    #     'player_2_game_2_completed',
    #     'player_2_game_3', 
    #     'player_2_game_3_completed',
    #     'player_2_game_4', 
    #     'player_2_game_4_completed',
    #     'player_2_game_5', 
    #     'player_2_game_5_completed',
    #     'golden_game', 
    #     'golden_game_completed'
    # ]
