...
def _qr_svg(data: str) -> str:
    ...
    # SVG is generated by the qrcode lib (data encoded as path geometry, never
    # rendered as markup), so there is no XSS vector.
    return mark_safe(svg[svg.find("<svg"):])  # nosec
