...
class eventTest:
    ...
    def get_sport_events(self,sport, file):
...
class testTeam:
    ...
    def test1(self):
        ...
        print(TeamSerializer(teamCron.check_team(teams[0].team_name, teams[0].title, teams[0].group)).data)
        x = 0

        for team in teams:
            x += 1
            TeamSerializer(teamCron.check_team(team.team_name, team.title, team.group)).data
        print(x)
