// Alpine.js — CSP build (ESM module variant), vendored per plan js-portal-security D7/D8.
// Package: @alpinejs/csp@3.14.9  Source: https://cdn.jsdelivr.net/npm/@alpinejs/csp@3.14.9/dist/module.esm.js
// CSP build = no eval / no new Function (runs under script-src 'self'); component logic lives in Alpine.data() objects.
// Vendored (no npm/CDN at runtime). To update: re-download the pinned version, re-commit, bump this header.
